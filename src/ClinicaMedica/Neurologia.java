...
public class Neurologia extends Especialidade {
    ...
    static {
        medicos.add(new Medico("Dr. Daniel", new Neurologia()));
        medicos.add(new Medico("Dr. Francisco", new Neurologia()));
        medicos.add(new Medico("Dr. Vitor", new Neurologia()));
