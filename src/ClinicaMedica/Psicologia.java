...
public class Psicologia extends Especialidade {
    ...
    static {
        medicos.add(new Medico("Dr. Antônio", new Psicologia()));
        medicos.add(new Medico("Dr. Mario", new Psicologia()));
        medicos.add(new Medico("Dr. Eduardo", new Psicologia()));
